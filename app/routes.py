...
def submit_entry():
    ...
    new_data = [
        ...
        q(data.get('address1')),
        q(data.get('address2')),
        f"{latest_sums['exempt']:.2f}",
        f"{latest_sums['zero']:.2f}",
        f"{latest_sums['serv']:.2f}",
        f"{latest_sums['cap']:.2f}",
        f"{latest_sums['other']:.2f}",
        f"{latest_sums['inputtax']:.2f}",
        f"{latest_sums['inputtax']:.2f}",
        "0.00",
        rdo,
        period,
